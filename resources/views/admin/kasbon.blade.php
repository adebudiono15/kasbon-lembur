            ...
            <div class="row mt--2 justify-content-center">
                <div class="col-md-6">
                    <div class="card full-height">
                        <div class="card-body">
                            <form action="{{ route('save-kasbon') }}" method="post">
                            @csrf
                            <input type="text" id="kode_karyawan"  value="{{ Auth::user()->nip }}" hidden>
                            <div class="card-title">Pengajuan Kasbon</div>
                            ...
                            <label for="lembur" class="mt-3"><b>Jumlah Pengajuan Kasbon</b></label>
                            <div class="input-group mt-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Rp.</span>
                                </div>
                                <input type="text" class="form-control" name="total_kasbon" aria-label="Amount (to the nearest dollar)">
